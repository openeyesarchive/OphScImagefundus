...
/**
 * This is the model class for table "et_ophscimagefundus_document".
 *
...
class Element_OphScImagefundus_Document extends ElementScannedDocument
{
	public $service;
	...
	{
		return 'et_ophscimagefundus_document';
	}
